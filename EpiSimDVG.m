function dx = EpiSimDVG(t,x,g,p,K,a,f,ne,ni,n,TVac,epsv)
%% EpiSimD (t,x,g,p,K,a,f,ne,ni,n,TVac,epsv)
% Simulates epidemic retruns the state of the
...
dx=zeros(ne+ni+1,1); % define the size of the dx vector to be returned
